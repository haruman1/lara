<div>
    <div class="mb-6">
        ...
        <p class="mt-1 text-sm text-gray-600">
            You are logged in as: <span class="font-medium text-blue-600">{{ $userRole }}</span>
        </p>
    </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ ucfirst($userRole) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                ...
                <div class="flex items-center">
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            ...
                            <dd class="text-lg font-medium text-gray-900">{{ now()->format('M d, Y') }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
    ...
    <div class="bg-white shadow rounded-lg">
        <div class="px-4 py-5 sm:p-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div class="relative group bg-white p-6 rounded-lg border border-gray-200">
                    <div>
                    ...
                    <div class="mt-4">
                        ...
                        <p class="mt-2 text-sm text-gray-500">
                            Access your activity reports and analytics.
                        </p>
                    </div>
                </div>
                @endif
                ...
                <div class="relative group bg-white p-6 rounded-lg border border-gray-200">
                    ...
                    <div class="mt-4">
                        ...
                        <p class="mt-2 text-sm text-gray-500">
                            Get help with your account and find answers.
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="relative pb-8">
                            <div class="relative flex space-x-3">
                                ...
                                <div class="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                                    <div>
                                        <p class="text-sm text-gray-500">Successfully logged in</p>
                                    </div>
                                    <div class="text-right text-sm whitespace-nowrap text-gray-500">
                                        <time datetime="{{ now()->toISOString() }}">{{ now()->format('M d, Y H:i') }}</time>
                                    </div>
                                </div>
                            </div>
                        </div>
