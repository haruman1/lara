<section id="blog" class="relative bg-gray-50 dark:bg-gray-900 transition-colors duration-500">
    <!-- Card Blog -->
    <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <!-- Title -->
        <div class="max-w-2xl mx-auto text-center mb-10 lg:mb-14">
            <h2 class="text-2xl font-bold md:text-4xl md:leading-tight dark:text-white" data-lang-key="blog-header">
                Insights</h2>
            <p class="mt-1 text-gray-600 dark:text-neutral-400" data-lang-key="blog-subheader">Stay in the know with
        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <!-- Card -->
            <a class="group flex flex-col focus:outline-hidden" href="#masihbener">
                <div class="relative pt-[50%] sm:pt-[70%] rounded-xl overflow-hidden">
                    <img class="size-full absolute top-0 start-0 object-cover group-hover:scale-105 group-focus:scale-105 transition-transform duration-500 ease-in-out rounded-xl"
