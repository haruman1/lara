                ...
                <div class="mt-12 grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
                    ...
                    <div class="divide-y divide-gray-200 dark:divide-neutral-800">
                        ...
                        <div class=" flex gap-x-7 py-6">
                            ...
                            <div class="grow">
                                <h3 class="font-semibold text-gray-800 dark:text-neutral-200">Working hours</h3>
                                <p class="mt-1 text-sm text-gray-500 dark:text-neutral-500">Monday - Friday: 8AM - 5PM
                                </p>
                                <a class="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 focus:outline-hidden focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
                                    href="#">
                                    View hours
                        ...
                        <div class=" flex gap-x-7 py-6">
                            ...
                            <div class="grow">
                                ...
                                <a class="mt-2 inline-flex items-center gap-x-2 text-sm font-medium text-gray-600 hover:text-gray-800 focus:outline-hidden focus:text-gray-800 dark:text-neutral-400 dark:hover:text-neutral-200 dark:focus:text-neutral-200"
                                    href="mailto:sales@bcompnetsolutions.com">
                                    sales@bcompnetsolutions.com
                                </a>
                            </div>
                        </div>
                        <!-- End Icon Block -->
