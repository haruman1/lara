    ...
    <div class="relative bg-white dark:bg-gray-900 bg-gray-50 transition-colors duration-500">
        <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                <div
                    ...
                    <div class="flex items-center gap-x-4">
                        <img class="rounded-full size-20"
                            src="
                            https://github.com/haruman1.png?size=320&w=320&v=4"
                            alt="Avatar">
                        <div class="grow">
                ...
                <a class="col-span-full lg:col-span-1 group flex flex-col justify-center text-center rounded-xl p-4 md:p-6 border border-dashed border-gray-200 hover:shadow-2xs focus:outline-hidden focus:shadow-2xs dark:border-neutral-700"
                    href="#">
